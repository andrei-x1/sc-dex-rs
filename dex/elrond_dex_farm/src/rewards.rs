    ...
    + farm_token::FarmTokenModule
{
    ...
    fn reward_per_share(&self) -> SingleValueMapper<Self::Storage, BigUint>;

    #[view(getRewardReserve)]
    #[storage_mapper("reward_reserve")]
    fn reward_reserve(&self) -> SingleValueMapper<Self::Storage, BigUint>;

    #[storage_mapper("undistributed_fee_storage")]
    fn undistributed_fee_storage(&self) -> SingleValueMapper<Self::Storage, BigUint>;

    #[storage_mapper("current_block_fee_storage")]
    fn current_block_fee_storage(
        &self,
    ) -> SingleValueMapper<Self::Storage, Option<(Nonce, BigUint)>>;
}
